...
* error variants (https://github.com/rustls/rustls-ffi/pull/574):
...
* Updated rustls-platform-verifier from 0.5.3 to
  [0.6.2](https://github.com/rustls/rustls-platform-verifier/releases/tag/v%2F0.6.2) 
