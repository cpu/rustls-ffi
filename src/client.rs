...
impl rustls_client_config_builder {
    ...
    ///
    /// The provided `ech_config_list_der` and `rustls_hpke` must not be NULL or an
    /// error will be returned. The caller maintains ownership of the ECH config list DER
    ...
    pub extern "C" fn rustls_client_config_builder_enable_ech(
        ...
        ffi_panic_boundary! {
            ...
            builder.ech_mode =
                match EchConfig::new(EchConfigListBytes::from(ech_config_list_der), hpke.suites) {
